        ...
        <div class="page-title mb-4">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Upload Laporan Akhir</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url('laporan/akhir') ?>">Laporan Akhir</a></li>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <?php echo form_open_multipart('laporan/tambahakhir'); ?>
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3 justify-content-end">
                                <div class="col-lg-9">
                                    ...
                                    <a href="<?= base_url('laporan/akhir') ?>" class="btn btn-secondary">
                                        Kembali
                                    </a>
                                </div>
                            </div>
