        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <?php echo form_open_multipart('sistem_mutu/tambah'); ?>
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <label for="kode" class="col-lg-3 col-form-label">Kode Dokumen</label>
                                <div class="col-lg-9">
                                    <input placeholder="Kode Dokumen" autofocus autocomplete="off" class="form-control <?= form_error('kode') ? 'is-invalid' : ''; ?>" type="text" name="kode">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input placeholder="Jenis Sistem Mutu..." autocomplete="off" class="form-control <?= form_error('jenis') ? 'is-invalid' : ''; ?>" type="text" name="jenis">
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        <?= form_error('jenis'); ?>
                                    </div>
                                </div>
