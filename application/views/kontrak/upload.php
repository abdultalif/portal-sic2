                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input placeholder="tanggal" autocomplete="off" class="form-control <?= form_error('tanggal') ? 'is-invalid' : ''; ?>" type="text" id="tanggal" name="tanggal">
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        <?= form_error('tanggal'); ?>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <div class="form-check">
                                        <input class="form-check-input <?= form_error('jenis') ? 'is-invalid' : ''; ?>" value="Kontrak Auditee" type="radio" name="jenis" id="jenis">
                                        <label class="form-check-label" for="jenis">
                                            Kontrak Auditee
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input <?= form_error('jenis') ? 'is-invalid' : ''; ?>" type="radio" name="jenis" id="jenis" value="Kontrak Auditor">
                                        <label class="form-check-label" for="jenis">
                                            Kontrak Auditor
                                        </label>
                                        <div id="validationServer03Feedback" class="invalid-feedback">
